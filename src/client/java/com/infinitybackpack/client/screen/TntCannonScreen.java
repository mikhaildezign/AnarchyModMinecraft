...
public class TntCannonScreen extends AbstractContainerScreen<TntCannonMenu> {
    private static final ResourceLocation TEXTURE = ResourceLocation.withDefaultNamespace("textures/gui/container/dispenser.png");

    public TntCannonScreen(TntCannonMenu menu, Inventory playerInventory, Component title) {
